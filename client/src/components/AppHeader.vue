<template>
	<header>
		...
		<div class="header-right" id="header-right" :class="{active: isActive}">
			<router-link class="header-item" to="/about" @click.native="isActive = false">About</router-link>
			<router-link class="header-item" to="/user" @click.native="isActive = false">Profile</router-link>
